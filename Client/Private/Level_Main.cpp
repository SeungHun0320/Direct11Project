...
HRESULT CLevel_Main::Initialize()
{
	...
	if (FAILED(Load_Map(TEXT("Main.Map"))))
		return E_FAIL;
	...
	m_pBGM = m_pGameInstance->Get_Single_Sound("Fortress_Main");
...
HRESULT CLevel_Main::Ready_Layer_Pawn(const _wstring& strLayerTag)
{
	//이 레벨의 플레이어 생성위치
	_float3 vInitPosition = { 0.f, 0.f, 13.f };
...
HRESULT CLevel_Main::Ready_Layer_Camera(const _wstring& strLayerTag)
{
