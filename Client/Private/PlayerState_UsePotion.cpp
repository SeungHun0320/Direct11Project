...
void CPlayerState_UsePotion::Enter(_float fTimeDelta)
{
	...
	m_pOwner->Set_MeshVisible(CPlayer::MESHES::MESH_POTION, false);
	m_pOwner->Set_MeshVisible(CPlayer::MESHES::MESH_POTION2, false);

	m_pOwner->Change_Animation(CPlayer::ANIM_STATES::USE_POTION, false, 0.2f);
}
