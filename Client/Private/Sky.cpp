...
LIFE CSky::Update(_float fTimeDelta)
{
...
HRESULT CSky::Ready_Components(void* pArg)
{
    ...
    /* For.Com_Texture */
    if (FAILED(__super::Add_Component(ENUM_CLASS(m_eLevelID), TEXT("Prototype_Component_Texture_Sky"),
...
HRESULT CSky::Bind_ShaderResources()
{
    ...
    if (FAILED(m_pTextureCom->Bind_ShaderResource(m_pShaderCom, "g_DiffuseTexture", 4)))
        return E_FAIL;
