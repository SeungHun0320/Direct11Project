...
class CWizard_Candleabra final : public CWizard
{
public:
	typedef struct tagWizardCandleabraDesc : public CWizard::DESC
	{

	}DESC;

public:
	enum PART { PART_BODY, PART_SWORD, PART_CANDLEABRA, PART_HP, PART_LOCKON, PART_EFFECT,  PART_END };
