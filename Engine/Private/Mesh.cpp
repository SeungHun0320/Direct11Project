...
HRESULT CMesh::Initialize_Prototype(MODEL eType, const MESH* pDesc, _fmatrix PreTransformMatrix)
{
...
HRESULT CMesh::Ready_NonAnim_Mesh(const MESH* pDesc, _fmatrix PreTransformMatrix)
{
	m_iVertexStride = sizeof(VTXMESH);
...
HRESULT CMesh::Ready_Anim_Mesh(const MESH* pDesc)
{
...
CMesh* CMesh::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, MODEL eType, const MESH* pDesc, _fmatrix PreTransformMatrix)
{
