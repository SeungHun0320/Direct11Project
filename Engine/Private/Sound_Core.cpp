...
void CSound_Core::Update3DPosition(_fvector vPos)
{
    _vector vSoundVel = vPos - XMLoadFloat3(&m_vSoundPos);

    XMStoreFloat3(&m_vSoundPos, vPos);
    XMStoreFloat3(&m_vSoundVel, vSoundVel);
