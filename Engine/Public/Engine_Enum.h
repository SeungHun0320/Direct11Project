...
namespace Engine
{
    enum class COLLIDER { AABB, OBB, SPHERE, COL_END };
    enum class MODEL { NONANIM, ANIM };
	enum class PROTOTYPE { TYPE_GAMEOBJECT, TYPE_COMPONENT };
	enum class RENDERGROUP { RG_PRIORITY, RG_PRIORITY_SHADOW, RG_SHADOW, RG_NONBLEND, RG_DEPTH_NONLIGHT, RG_NONLIGHT, RG_BLEND, RG_UI, RG_END };
