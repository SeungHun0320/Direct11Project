...
public:
	...
	/* 메쉬용 */
	_float3 Compute_PickedPosition_LocalEx(_fmatrix WorldMatrixInverse, _float& fDist);
	_float3 Compute_PickedPosition_WorldEx(const _float4x4* pWorldMatrix, _float& fDist);
	_float3 Compute_PickedPosition_World_SnapEx(const _float4x4* pWorldMatrix, _float& fDist);
